...
function dec(element) {
    ...
    if (element.nextSibling.nextSibling.textContent < 0) {
        element.nextSibling.nextSibling.textContent = 0;
    }
}
...
function add(element) {
    ...
    let addedItems = cart.getElementsByClassName("cart__product-image");
